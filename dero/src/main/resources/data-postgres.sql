...
insert into user_table (address, city, country, email, first_name, jmbg, last_name, password, telephone) values ('Adresa14', 'Honolulu', 'Hawaii', 'gogi@gmail.com', 'Goran', '1508550058987', 'Dragic', 'sifra14', '061151563');
insert into user_table (address, city, country, email, first_name, jmbg, last_name, password, telephone) values ('Adresa15', 'Kopaonik', 'Srbija', 'lbj@gmail.com', 'LeBron', '1508555558123', 'James', 'sifra15', '066661563');
insert into user_table (address, city, country, email, first_name, jmbg, last_name, password, telephone) values ('Adresa16', 'Kamchatka', 'Rusija', 'cr7@gmail.com', 'Cristiano', '1508444458987', 'Ronaldo', 'sifra16', '062144563');
insert into medical_staff(id, clinic_id, vac_req_id) values (14, 1, null);
insert into medical_staff(id, clinic_id, vac_req_id) values (15, 1, null);
insert into medical_staff(id, clinic_id, vac_req_id) values (16, 1, null);
insert into doctor (id, specialised_type_id) values (14, null);
insert into doctor (id, specialised_type_id) values (15, null);
insert into doctor (id, specialised_type_id) values (16, null);