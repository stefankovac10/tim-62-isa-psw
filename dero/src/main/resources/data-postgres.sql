...
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name,password, telephone) values ('Adresa1', 'Novi Sad', 'Srbija', 'pera@gmail.com', false, 'Pera', '1512998189687', 'Peric', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '066998585');
insert into clinic_center_administrator(log_first_time, id) values (false, 1);
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name,password, telephone) values ('Adresa2', 'Novi Sad', 'Srbija', 'mika@gmail.com', false, 'Mika', '1512998186917', 'Mikic', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '066777585');
insert into clinic_center_administrator(log_first_time, id) values (true, 2);
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name, password, telephone) values ('Adresa3', 'Beograd', 'Srbija', 'jova@gmail.com', false, 'Jovan', '1507991158987', 'Jovanovic', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '068978563');
insert into clinic_administrator (clinic_id, id) values (1, 3);
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name, password, telephone) values ('Adresa4', 'Beograd', 'Srbija', 'zika@gmail.com', false, 'Zivan', '1508971158987', 'Zivanovic', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '062222563');
insert into clinic_administrator (clinic_id, id) values (1, 4);
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name, password, telephone) values ('Adresa5', 'Beograd', 'Srbija', 'isa2019klinicki.centar@gmail.com', false, 'Milos', '1508555558987', 'Milosevic', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '062111563');
insert into registration_request (verified, id) values (false, 5);
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name, password, telephone) values ('Adresa6', 'Nevesinje', 'Republika Srpska', 'marija@gmail.com', false, 'Marija', '1592897368425', 'Marijanovic', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '068953685');
...
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name, password, telephone) values ('Adresa7', 'Nevesinje', 'Republika Srpska', 'jelena@gmail.com', false, 'Marija', '1592890000025', 'J', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '068950000');
insert into medical_staff (clinic_id, vac_req_id, id) values (1, null, 7);
insert into nurse (id) values (7);
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name, password, telephone) values ('Bulevar despota Stefana', 'Novi Sad', 'Republika Srbija', 'mica@gmail.com', false, 'Milica', '1592812341234', 'Injac', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '0689504040');
insert into medical_staff (clinic_id, vac_req_id, id) values (1, null, 8);
insert into nurse (id) values (8);
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name, password, telephone) values ('Adresa8', 'Nevesinje', 'Republika Srpska', 'jeca@gmail.com', false, 'Marija', '1592891011025', 'Jovanovic', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '0689513110');
insert into patient (med_rec_id, id) values (1, 9);
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name, password, telephone) values ('Safarikova', 'Novi Sad', 'Republika Srbija', 'marko@gmail.com', false, 'Marko', '1592811110025', 'Jovic', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '0689511210');
insert into patient (med_rec_id, id) values (2, 10);
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name, password, telephone) values ('Sekspirova', 'Novi Sad', 'Republika Srbija', 'marko123@gmail.com', false, 'Marko', '1592812110025', 'Jovic', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '0689511230');
...
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name, password, telephone) values ('Heroja pinkija', 'Novi Sad', 'Republika Srbija', 'mirko@gmail.com', false, 'Mirko', '1592813110025', 'Moric', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '0689511240');
...
insert into user_table (address, city, country, email, enabled, first_name, jmbg, last_name, password, telephone) values ('Veselina Maslese', 'Novi Sad', 'Republika Srbija', 'vesko@gmail.com', false, 'Vesko', '1592814110025', 'Loric', '$2a$10$bDZRwWeg.DyljrjK9iaOTORx89yRAKYP/fRfjupA9tfi5dmtfNhQm', '0689511250');
